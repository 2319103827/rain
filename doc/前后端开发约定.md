...
```html
<form>
	成功状态：<input type="text" name="status_success_msg" value="OK" />
    等待状态：<input type="text" name="status_wait_msg" value="正在审核" />
	失败状态：<input type="text" name="status_fail_msg" value="审核失败" />
